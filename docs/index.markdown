...
<iframe src="{{ 'images/network_analysis.html' | relative_url }}" width="100%" height="600px" frameborder="0"></iframe>
...
<iframe src="{{ 'images/genres_by_share.html' | relative_url }}" width="100%" height="600px" frameborder="0"></iframe>
